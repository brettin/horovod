...
aprun -n 8 -N 1 -d 256 -j 4 -cc depth -e KMP_SETTINGS=1 -e KMP_BLOCKTIME=30 -e KMP_AFFINITY="granularity=fine,verbose,compact,1,0" -e OMP_NUM_THREADS=144 -b $DIR/keras_mnist_theta.sh
